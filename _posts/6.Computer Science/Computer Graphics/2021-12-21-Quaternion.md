...
​	유사하게, 각각 쿼터니언 $p$​​​​​​​​​​​​​​​와 $q$​​​​​​​​​​​​​​​에 의해 결정된 좌표계의 회전을 수행하는 쿼터니언 연산자 $L_{q^*}(u) = {p^*vq}$​​​​​​​​​​​​​​​ 및
$L_{q^*}(v) = {q^*vq}$​​​​​​​​​​​​​​​를 고려하자. 쿼터니언 곱 $pq$​​​​​​​​​​​​​​​는 연산자 $L_{(pq)^*}$​​​​​​​​​​​​​​​를 정의한다.
이는 연산자 $L_{q^*}$​​​​​​​​​​​​​​​ 다음에
$L_{p^*}$​​​​​​​​​​​​​​​가 오는 시퀀스를 나타낸다.
$L_{(pq)^*}$​​​​​​​​​​​​​​​의 축과 회전 각도는 쿼터니언 곱 $pq$​​​​​​​​​​​​​​​로 표시되는 것이다.
...
좌표계를 회전시키므로 두 연산자 $L_{p^*}$​​​​​​​와
$L_{q^*}$​​​​​​​​가 순차적으로 적용된다.
복합 회전 연산자는 station frame의 좌표를 tracking frame 좌표로 변환하는 $L_{(pq)^*}$​​​​​​​이다. 그리고 구성 회전을 설명하는 쿼터니언은 다음과 같은 곱 $pq$​​​​​​​이다.
